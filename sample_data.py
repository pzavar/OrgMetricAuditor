...
It contains the sample data in a format that can be used for reference.
The actual sample data loading is handled by the load_sample_data function in utils.py.
"""

SAMPLE_DATA = """Department,Metric_Name,Visible_in_Dashboard,Used_in_Decision_Making,Executive_Requested,Last_Reviewed,Metric_Last_Used_For_Decision,Interpretation_Notes
